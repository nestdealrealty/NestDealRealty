                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '20px' }}>
                            <div style={{ marginBottom: '5px' }}>
                                ...
                                <div style={{ display: 'flex', gap: '10px' }}>
                                    ...
                                    <button onClick={() => updateForm('sourceProfession', 'COWORKER')} style={{ flex: 1, padding: '12px', background: formData.sourceProfession === 'COWORKER' ? `${THEME.gold}20` : 'transparent', border: `1px solid ${formData.sourceProfession === 'COWORKER' ? THEME.gold : THEME.border}`, color: formData.sourceProfession === 'COWORKER' ? THEME.gold : THEME.text, borderRadius: '8px', cursor: 'pointer' }}>COWORKER</button>
                                </div>
                            </div>
